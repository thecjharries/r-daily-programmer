...
func (s *MainSuite) TestDeterminePromptYears(c *C) {
	c.Assert(determinePromptYears(parseYears()), DeepEquals, []int{1822, 1823, 1824, 1825, 1826, 1831, 1833, 1834, 1835, 1836, 1837, 1838, 1839, 1840, 1841, 1843, 1844, 1845})
}
